...
export class OrderStatusCancelledStateAdded1772462879824 implements MigrationInterface {
    name = 'OrderStatusCancelledStateAdded1772462879824'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."order_status_enum" RENAME TO "order_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."order_status_enum" AS ENUM('Pending', 'Confirmed', 'Cancelled', 'Complete', 'Failed', 'Returned')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."order_status_enum_old" AS ENUM('Pending', 'Confirmed', 'Complete', 'Failed', 'Returned')`);
        await queryRunner.query(`ALTER TABLE "order" ALTER COLUMN "status" DROP DEFAULT`);
